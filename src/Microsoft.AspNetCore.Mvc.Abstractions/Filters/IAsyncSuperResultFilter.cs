...
{
    /// <summary>
    /// An filter that asynchronously surrounds execution of all action results.
    /// </summary>
    /// <remarks>
    /// <para>
    /// The <see cref="IAsyncSuperResultFilter"/> interface declares an <see cref="IAsyncResultFilter"/> implementation
    ...
    /// </para>
    /// </remarks>
    public interface IAsyncSuperResultFilter : IAsyncResultFilter
    {
    }
}
