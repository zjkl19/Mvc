...
{
    /// <summary>
    /// An filter that surrounds execution of all action results.
    /// </summary>
    /// <remarks>
    /// <para>
    /// The <see cref="ISuperResultFilter"/> interface declares an <see cref="IResultFilter"/> implementation
    ...
    /// </para>
    /// </remarks>
    public interface ISuperResultFilter : IResultFilter
    {
    }
}
